AFRAME.registerComponent("bullets",{
    ...
    shootBullet:function(){
        window.addEventListener("keydown",(e)=>{
            if(e.key=="z"){
                ...
                var camera= document.querySelector("#camera-ring")
    ...
    removeBullets:function(e){
            ...
            console.log(elementCollided.id.includes("box"))



            if(elementCollided.id.includes("box")){
    ...
    shootSound:function(){
        var soundE = document.querySelector("#sound2")
